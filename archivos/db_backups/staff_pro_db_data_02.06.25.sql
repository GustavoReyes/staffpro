...
CREATE TABLE `employees` (
  ...
  `work_day` int DEFAULT NULL COMMENT 'jornada diaria, 30h, 40h',
  ...
  CONSTRAINT `RelarionUser` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `users` VALUES (1,'gustavo@mail.com','$2b$10$j/YXIqEKWkmkAeZEzVFv0eytzLHSgzGYBFGymJamxsqysAnZTciY2');
...
-- Dump completed on 2025-06-02 12:34:26
